...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: {
    ...
    upperCaseMessage: function upperCaseMessage() {
  ...
  methods: _objectSpread({
    mutateMessage: function mutateMessage() {
      this.$store.commit("changeMessage");
    }
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(['getTestTitle'])),
  ...
  return _c("div", [
    ...
    _c("div", [
      ...
      _c("ul", [
        ...
        _vm._v(" "),
        _c("li", [
          _vm._v("Getter - uppercase: "),
          _c("b", [_vm._v(_vm._s(_vm.upperCaseMessage))])
        ]),
        _vm._v(" "),
        _c("li", [
          _c("button", { on: { click: _vm.mutateMessage } }, [
            _vm._v("Mutate Message")
          ])
        ]),
        _vm._v(" "),
        _c("li", [
          _c("p", [_vm._v("Fetch data using mutations and actions from API")]),
          _vm._v(" "),
          _c("div", [
            _vm._v("data.title: "),
            _c("b", [_vm._v(_vm._s(_vm.test))])
          ]),
          _vm._v(" "),
          _vm._m(0)
        ])
      ...
      _c("small", [
        _c("i", [
          ...
          _c(
            ...
            [_vm._v("https://jsonplaceholder.typicode.com/todos/1")]
          )
        ])
      ])
    ])
